...
public class EmprestimoDTO {
    ...
    public String getProdutoPrateleira() {
        return produtoPrateleira;
    }

    public void setProdutoPrateleira(String produtoPrateleira) {
        this.produtoPrateleira = produtoPrateleira;
    }

    public String getProdutoOrigem() {
        return produtoOrigem;
    }

    public void setProdutoOrigem(String produtoOrigem) {
        this.produtoOrigem = produtoOrigem;
    }
}